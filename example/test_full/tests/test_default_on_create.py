...
class DefaultOnCreateNC(TestCase):
    def setUp(self):
    ...
    def test_created_fk(self):
        self.p1.refresh_from_db()
        self.p2.refresh_from_db()
        self.assertEqual(self.p1.children_names, 'C1,C11')  # due to 2nd save, now claced values
        self.assertEqual(self.p2.children_names, '')

    def test_created_m2m(self):
        self.c1.refresh_from_db()
        self.c11.refresh_from_db()
        self.assertEqual(self.c1.toy_names, 'T1')
        self.assertEqual(self.c11.toy_names, '')

    def test_created_m2m_back(self):
        self.t1.refresh_from_db()
        self.t2.refresh_from_db()
        self.assertEqual(self.t1.children_names, 'C1')
        self.assertEqual(self.t2.children_names, '')
    ...
    def test_copyclone_fk(self):
        ...
        with not_computed(recover=True):
            ...
            self.p1.save()
        self.p1.refresh_from_db()
        self.assertEqual(self.p1.children_names, '')
    ...
    def test_copyclone_m2m(self):
        ...
        self.c1.refresh_from_db()
        self.assertEqual(list(self.c1.toys.all()), [])
        self.assertEqual(self.c1.toy_names, '')
    ...
    def test_copyclone_m2m_back(self):
        ...
        self.t1.refresh_from_db()
        self.assertEqual(list(self.t1.children.all()), [])
        self.assertEqual(self.t1.children_names, '')
