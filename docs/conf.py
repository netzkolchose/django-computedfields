...
htmlhelp_basename = 'django-computedfieldsdoc'
...
man_pages = [
    (master_doc, 'django-computedfields', 'django-computedfields Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'django-computedfields', 'django-computedfields Documentation',
     author, 'django-computedfields', 'One line description of project.',
     'Miscellaneous'),
]
